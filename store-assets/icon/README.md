...
- `maxfield-link-overlay-icon-source.png`: 1254 × 1254 colored-pencil source artwork selected from Concept 5, Variant A.
- `maxfield-link-overlay-icon-512.png`: 512 × 512 full-white-background PNG for the Google Play store listing.
- `app/src/main/res/drawable-nodpi/ic_launcher_colored_pencil_foreground.png`: transparent-background launcher foreground mechanically derived from the selected artwork.
